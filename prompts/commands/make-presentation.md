...
- `read_workspace_file` on `docs/ARCHITECTURE_OVERVIEW.md` — output of `/architecture-doc` (components, data flow, MCP tools)
- `read_workspace_file` on `docs/ARCHITECTURE_DETAIL.md` — output of `/architecture-doc` (security, network, design decisions)
